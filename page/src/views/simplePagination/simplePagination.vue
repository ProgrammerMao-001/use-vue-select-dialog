...
export default {
  ...
  provide() {
    return {
      requestName: getDeptList,
      // requestName: (params) => getDeptList(params)
  ...
  methods: {
    interfaceName(params) {
      let url = process.env.VUE_APP_BASE_API + "/getDeptListWithPagination";
